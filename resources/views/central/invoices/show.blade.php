                    ...
                    <table class="table table-hover align-middle">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td class="text-end">{{ format_price($invoice->amount) }}</td>
                            </tr>
                        </tbody>
                        <tfoot class="bg-light">
                            <tr>
                                <td class="text-end text-uppercase fs-6 fw-semibold">Total</td>
                                <td class="text-end fs-5 fw-bold">{{ format_price($invoice->amount) }}</td>
                            </tr>
                        </tfoot>
                    </table>
                </div>
            ...
            <div class="modal-body">
                <form action="{{ route('central.invoices.pay', $invoice->id) }}" method="POST">
                    ...
                    <div class="form-group mb-3">
                        ...
                        <small class="text-muted">Maximum amount: {{ format_price($invoice->amount) }}</small>
                    </div>
                    <div class="mb-3">
