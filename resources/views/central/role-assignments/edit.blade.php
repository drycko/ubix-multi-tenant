    ...
    <div class="row mb-2">
      ...
      <div class="col-sm-6">
        <ol class="breadcrumb float-sm-right">
          ...
          <li class="breadcrumb-item"><a href="{{ route('central.role-assignments.index') }}">Role Assignments</a></li>
    ...
    <div class="row">
      <div class="col-md-8">
        ...
        <div class="card card-success card-outline">
          ...
          <form action="{{ route('central.role-assignments.update', $user) }}" method="POST">
            @csrf
            @method('PUT')
            <div class="card-body">
              <div class="mb-4">
            ...
            <div class="card-footer">
              <div class="d-flex justify-content-between">
                <a href="{{ route('central.role-assignments.index') }}" class="btn btn-outline-secondary">
        ...
        <div class="card card-outline card-primary">
          ...
          <div class="card-body">
            <div class="d-grid gap-2">
              <a href="{{ route('central.users.show', $user) }}" class="btn btn-outline-primary">
                <i class="fas fa-user me-2"></i>View User Profile
              </a>
              <a href="{{ route('central.users.edit', $user) }}" class="btn btn-outline-warning">
