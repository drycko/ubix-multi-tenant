    ...
    <div class="row mb-2">
      ...
      <div class="col-sm-6">
        <ol class="breadcrumb float-sm-end">
          ...
          <li class="breadcrumb-item"><a href="{{ route('central.permissions.show', $permission) }}">{{ $permission->name }}</a></li>
    ...
    <div class="row">
      <div class="col-md-8">
        ...
        <div class="card card-warning card-outline">
          ...
          <form action="{{ route('central.permissions.update', $permission) }}" method="POST">
            @csrf
            @method('PUT')
            <div class="card-body">
              <div class="mb-3">
            ...
            <div class="card-footer">
              <div class="d-flex justify-content-between">
                <a href="{{ route('central.permissions.show', $permission) }}" class="btn btn-outline-secondary">
