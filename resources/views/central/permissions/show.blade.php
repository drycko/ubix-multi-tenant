    ...
    <div class="card card-info card-outline">
      <div class="card-header">
        <div class="d-flex justify-content-between align-items-center">
          ...
          <div>
            <a href="{{ route('central.permissions.index') }}" class="btn btn-outline-secondary me-2">
              <i class="fas fa-arrow-left me-1"></i>Back to Permissions
            </a>
            @can('manage permissions')
            <a href="{{ route('central.permissions.edit', $permission) }}" class="btn btn-info">
        ...
        <div class="card">
          ...
          <div class="card-body">
                ...
                <div class="card bg-light h-100">
                  <div class="card-body">
                    <div class="d-flex justify-content-between align-items-start">
                      ...
                      <div class="ms-2">
                        <a href="{{ route('central.roles.show', $role) }}" class="btn btn-sm btn-outline-primary">
            ...
            <div class="text-center py-4">
              ...
              @can('manage roles')
              <a href="{{ route('central.roles.index') }}" class="btn btn-primary">
        ...
        <div class="card card-outline card-secondary">
          ...
          <div class="card-body">
            ...
            <div class="small">
              ...
              <div class="mb-1">
                <a href="{{ route('central.permissions.show', $related) }}" class="text-decoration-none">
