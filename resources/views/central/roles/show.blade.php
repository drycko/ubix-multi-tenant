    ...
    <div class="card card-primary card-outline">
      <div class="card-header">
        <div class="d-flex justify-content-between align-items-center">
          ...
          <div>
            <a href="{{ route('central.roles.index') }}" class="btn btn-outline-secondary me-2">
              <i class="fas fa-arrow-left me-1"></i>Back to Roles
            </a>
            @can('manage roles')
            @if(!in_array($role->name, ['super-user', 'super-manager', 'support']))
            <a href="{{ route('central.roles.edit', $role) }}" class="btn btn-warning">
        ...
        <div class="card mt-3">
          ...
          <div class="card-body">
            ...
            <div class="text-center py-4">
              ...
              @can('manage roles')
              @if(!in_array($role->name, ['super-user', 'super-manager', 'support']))
              <a href="{{ route('central.roles.edit', $role) }}" class="btn btn-primary">
        ...
        <div class="card mt-3">
          <div class="card-header">
            <div class="d-flex justify-content-between align-items-center">
              ...
              @can('assign roles')
              <a href="{{ route('central.role-assignments.index') }}" class="btn btn-sm btn-outline-primary">
          ...
          <div class="card-body">
            ...
            <div class="text-center py-3">
              ...
              @can('assign roles')
              <a href="{{ route('central.role-assignments.index') }}" class="btn btn-sm btn-outline-primary mt-2">
