    ...
    <div class="row">
      ...
      <div class="col-sm-6">
        <ol class="breadcrumb float-sm-end">
          ...
          <li class="breadcrumb-item active" aria-current="page">PayGate</li>
        </ol>
      </div>
    </div>
  </div>
...
<div class="app-content">
  ...
  <div class="container-fluid">
    ...
    <form action="{{ route('central.settings.paygate.update') }}" method="POST">
      @csrf
      @method('POST')
          ...
          <div class="card card-info card-outline">
            <div class="card-header">
              <h5 class="card-title mb-0">
                <i class="fas fa-credit-card me-2"></i>PayGate Payment Gateway Configuration
              </h5>
            </div>
            <div class="card-body">
              <div class="alert alert-info">
                ...
                Configure your PayGate merchant account at <a href="https://www.paygate.co.za" target="_blank">paygate.co.za</a>
              </div>
              ...
              <div class="row">
                <div class="col-md-6 mb-3">
                  ...
                  @enderror
                  <div class="form-text">Your PayGate merchant ID</div>
                </div>
                <div class="col-md-6 mb-3">
                ...
                <div class="col-md-12 mb-3">
                  ...
                  <div class="invalid-feedback">{{ $message }}</div>
                  @enderror
                  <div class="form-text">Leave blank if not configured in your PayGate account. This is stored securely and encrypted.</div>
                </div>
                <div class="col-md-6 mb-3">
            ...
            <div class="card-footer text-end">
              ...
              <button type="submit" class="btn btn-info">
                <i class="fas fa-save me-1"></i>Update PayGate Settings
              </button>
