				...
				<div class="table-responsive">
					<table class="table table-hover">
						...
						<tbody>
							...
							<tr>
								<td><a href="{{ route('central.plans.show', [$subscription->plan->id]) }}">{{ $subscription->plan->name }}</a></td>
								<td><a href="{{ route('central.tenants.show', [$subscription->tenant->id]) }}">{{ $subscription->tenant->name }}</a></td>
