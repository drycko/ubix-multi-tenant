...
@section('title', 'Edit Room Amenity')
...
<div class="app-content-header">
  <div class="container-fluid">
    <div class="row">
      <div class="col-sm-6">
        <h4 class="mb-0">Edit Room Amenity</h4>
        <small class="text-muted">{{ $roomAmenity->name }}</small>
      </div>
      <div class="col-sm-6">
        <ol class="breadcrumb float-sm-end">
          <li class="breadcrumb-item"><a href="{{ route('tenant.dashboard') }}">Home</a></li>
          <li class="breadcrumb-item"><a href="{{ route('tenant.room-amenities.index') }}">Room Amenities</a></li>
          <li class="breadcrumb-item"><a href="{{ route('tenant.room-amenities.show', $roomAmenity) }}">{{ $roomAmenity->name }}</a></li>
        ...
        <div class="card">
          <div class="card-header">
            <h5 class="card-title mb-0">
              <i class="bi bi-pencil"></i> Edit Room Amenity
            </h5>
          </div>
          <div class="card-body">
            <form action="{{ route('tenant.room-amenities.update', $roomAmenity) }}" method="POST">
              @csrf
              @method('PUT')
              ...
              <div class="row mb-4">
                ...
                <div class="col-md-6 mb-3">
                  ...
                  <input type="text" class="form-control @error('name') is-invalid @enderror" 
                         id="name" name="name" value="{{ old('name', $roomAmenity->name) }}" 
                ...
                <div class="col-md-6 mb-3">
                  ...
                  <input type="text" class="form-control @error('slug') is-invalid @enderror" 
                         id="slug" name="slug" value="{{ old('slug', $roomAmenity->slug) }}" 
                ...
                <div class="col-12 mb-3">
                  ...
                  <textarea class="form-control @error('description') is-invalid @enderror" 
                            ...
                            placeholder="Brief description of the amenity...">{{ old('description', $roomAmenity->description) }}</textarea>
                  @error('description')
                    <div class="invalid-feedback">{{ $message }}</div>
                  @enderror
                </div>
              ...
              <div class="row mb-4">
                ...
                <div class="col-md-6 mb-3">
                  ...
                  <input type="text" class="form-control @error('icon') is-invalid @enderror" 
                         id="icon" name="icon" value="{{ old('icon', $roomAmenity->icon) }}" 
                ...
                <div class="col-md-6 mb-3">
                  ...
                  <div class="border rounded p-3 text-center">
                    <i id="icon-preview" class="{{ old('icon', $roomAmenity->icon) }} fs-1 text-success"></i>
                    <div class="mt-2">
                      <small class="text-muted" id="icon-class-display">{{ old('icon', $roomAmenity->icon) }}</small>
                    </div>
                  </div>
                </div>
              </div>
                ...
                <div class="col-12">
                  <div class="d-flex gap-2">
                    <button type="submit" class="btn btn-warning">
                      <i class="bi bi-check-circle"></i> Update Amenity
                    </button>
                    <a href="{{ route('tenant.room-amenities.show', $roomAmenity) }}" 
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Auto-generate slug from name (only if slug is empty or matches current generated slug)
    let originalSlug = slugInput.value;
    nameInput.addEventListener('input', function() {
        if (!slugInput.value || slugInput.value === generateSlug(nameInput.value) || slugInput.value === originalSlug) {
    ...
    // Highlight currently selected icon button
