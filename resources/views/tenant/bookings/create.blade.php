        ...
        <form action="{{ route('tenant.bookings.store') }}" method="POST">
          ...
          <div class="row">
            <div class="col-md-4">
              <div class="form-group mb-3">
                ...
                <input type="date" class="form-control @error('arrival_date') is-invalid @enderror" id="arrival_date" name="arrival_date" required min="{{ $arrivalDate }}" value="{{ old('arrival_date', $arrivalDate) }}">
                @error('arrival_date')
          ...
          <div class="row">
            ...
            <div class="col-md-6 mb-3 ms-auto text-end">
              <a href="#" class="btn btn-sm btn-warning me-2" onclick="window.history.back();">
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-success" id="confirmAddGuestBtn">OK</button>
