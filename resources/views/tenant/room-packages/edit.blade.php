    ...
    <div class="row">
      <div class="col-sm-6">
        <h3 class="mb-0">
          ...
          <small class="text-muted">Edit Package</small>
        </h3>
      </div>
      <div class="col-sm-6">
...
<div class="app-content">
  <div class="container-fluid">
    ...
    <form action="{{ route('tenant.room-packages.update', $roomPackage) }}" method="POST" enctype="multipart/form-data" id="packageForm">
      @csrf
      @method('PUT')
          ...
          <div class="card">
            <div class="card-header">
              ...
              <div class="card-tools">
                <span class="badge bg-{{ $roomPackage->pkg_status === 'active' ? 'success' : 'secondary' }}">
            ...
            <div class="card-body">
              ...
              <div class="row mb-3">
                <div class="col-md-6">
                  ...
                  <input type="text" 
                         ...
                         id="pkg_name" 
                         name="pkg_name" 
                         value="{{ old('pkg_name', $roomPackage->pkg_name) }}" 
                         required>
                  @error('pkg_name')
                ...
                <div class="col-md-6">
                  ...
                  <input type="text" 
                         ...
                         id="pkg_sub_title" 
                         name="pkg_sub_title" 
                         value="{{ old('pkg_sub_title', $roomPackage->pkg_sub_title) }}" 
                         required>
                  @error('pkg_sub_title')
                    <div class="invalid-feedback">{{ $message }}</div>
                  @enderror
              ...
              <div class="mb-3">
                ...
                <x-trix-input id="pkg_description" name="pkg_description" :value="old('pkg_description', $roomPackage->pkg_description?->toTrixHtml())" autocomplete="off" />
              ...
              <div class="row mb-3">
                <div class="col-md-4">
                  ...
                  <select class="form-select @error('pkg_number_of_nights') is-invalid @enderror" 
                    ...
                    @for($i = 1; $i <= $maxNumOfNights; $i++)
                      <option value="{{ $i }}" {{ old('pkg_number_of_nights', $roomPackage->pkg_number_of_nights) == $i ? 'selected' : '' }}>
                        {{ $i }} {{ $i == 1 ? 'Night' : 'Nights' }}
                      </option>
                    @endfor
                  </select>
                ...
                <div class="col-md-4">
                  ...
                  <div class="input-group">
                    ...
                    <input type="number" 
                           ...
                           id="pkg_base_price" 
                           name="pkg_base_price" 
                           value="{{ old('pkg_base_price', $roomPackage->pkg_base_price) }}" 
                           min="0" 
                           step="0.01"
                           required>
                  </div>
                ...
                <div class="col-md-4">
                  ...
                  <select class="form-select @error('pkg_status') is-invalid @enderror" 
                          ...
                          name="pkg_status" 
                          required>
                    <option value="active" {{ old('pkg_status', $roomPackage->pkg_status) === 'active' ? 'selected' : '' }}>Active</option>
                    <option value="inactive" {{ old('pkg_status', $roomPackage->pkg_status) === 'inactive' ? 'selected' : '' }}>Inactive</option>
                  </select>
                  @error('pkg_status')
                    <div class="invalid-feedback">{{ $message }}</div>
                  @enderror
              ...
              <div class="row mb-3">
                <div class="col-md-6">
                  ...
                  <input type="number" 
                         ...
                         id="pkg_min_guests" 
                         name="pkg_min_guests" 
                         value="{{ old('pkg_min_guests', $roomPackage->pkg_min_guests) }}" 
                         min="1">
                ...
                <div class="col-md-6">
                  ...
                  <input type="number" 
                         ...
                         id="pkg_max_guests" 
                         name="pkg_max_guests" 
                         value="{{ old('pkg_max_guests', $roomPackage->pkg_max_guests) }}" 
                         min="1">
              ...
              <div class="row mb-3">
                <div class="col-md-6">
                  ...
                  <input type="date" 
                         ...
                         id="pkg_valid_from" 
                         name="pkg_valid_from" 
                         value="{{ old('pkg_valid_from', $pkg_valid_from) }}">
                ...
                <div class="col-md-6">
                  ...
                  <input type="date" 
                         ...
                         id="pkg_valid_to" 
                         name="pkg_valid_to" 
                         value="{{ old('pkg_valid_to', $pkg_valid_to) }}">
                  @error('pkg_valid_to')
                    <div class="invalid-feedback">{{ $message }}</div>
                  @enderror
                </div>
              ...
              <div class="mb-3">
                ...
                @if($gcsImageUrl)
                  <div class="mb-2">
                    <img src="{{ $gcsImageUrl }}" alt="{{ $roomPackage->pkg_name }}" 
              ...
              <div class="row">
                <div class="col-md-6">
                  ...
                  <div id="inclusions-container">
                    @if(old('pkg_inclusions') || (!old('pkg_inclusions') && count($inclusions) > 0))
                      @foreach(old('pkg_inclusions', $inclusions) as $index => $inclusion)
                        @if(!empty($inclusion))
                ...
                <div class="col-md-6">
                  ...
                  <div id="exclusions-container">
                    @if(old('pkg_exclusions') || (!old('pkg_exclusions') && count($exclusions) > 0))
                      @foreach(old('pkg_exclusions', $exclusions) as $index => $exclusion)
                        @if(!empty($exclusion))
                          <div class="input-group mb-2">
                            <input type="text" 
                                   class="form-control" 
              ...
              @foreach($daysOfWeek as $day)
                <div class="form-check">
                  <input class="form-check-input @error('pkg_checkin_days') is-invalid @enderror" 
                         ...
                         value="{{ $day }}"
                         {{ in_array($day, old('pkg_checkin_days', $selectedCheckinDays)) ? 'checked' : '' }}>
                  ...
                  @foreach($rooms as $room)
                    <div class="form-check">
                      <input class="form-check-input @error('pkg_rooms') is-invalid @enderror" 
                             ...
                             name="pkg_rooms[]" 
                             value="{{ $room->id }}"
                             {{ in_array($room->id, old('pkg_rooms', $selectedRooms)) ? 'checked' : '' }}>
          ...
          <div class="card mt-3">
            <div class="card-body">
              <div class="d-grid gap-2">
                ...
                <a href="{{ route('tenant.room-packages.show', $roomPackage) }}" 
