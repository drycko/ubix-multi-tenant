              ...
              <tr>
                ...
                <td>
                  <div class="btn-group btn-group-sm">
                    <a href="{{ route('tenant.users.show', $user) }}" class="btn btn-outline-primary" title="View User">
                      <i class="fas fa-eye"></i>
                    </a>
                    <a href="{{ route('tenant.role-assignments.edit', $user) }}" class="btn btn-outline-success" title="Edit Roles">
...
<div class="modal fade" id="bulkAssignModal" tabindex="-1">
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      <form action="{{ route('tenant.role-assignments.bulk-assign') }}" method="POST">
        @csrf
