    ...
    <div class="row">
      <div class="col-sm-6">
        <h3 class="mb-0">
          ...
          <small class="text-muted">Add New Guest</small>
        </h3>
      </div>
      <div class="col-sm-6">
...
<div class="app-content">
  <div class="container-fluid">
    ...
    <form action="{{ route('tenant.guests.store') }}" method="POST">
      @csrf
          ...
          <div class="card card-primary card-outline mb-3">
            ...
            <div class="card-body">
              ...
              <div class="row">
                ...
                <div class="col-md-6">
                  <div class="mb-3">
                    ...
                    <select name="nationality" id="nationality" class="form-select select2-multi @error('nationality') is-invalid @enderror">
                      <option value="">Select Nationality</option>
                      @foreach($countries as $country)
                        <option value="{{ $country['code'] }}" {{ old('nationality') === $country['name'] ? 'selected' : '' }}>
                          <img src="{{ $country['flag'] }}" alt="{{ $country['name'] }}" class="flag-icon"> {{ $country['name'] }}
                        </option>
                      @endforeach
                    </select>
                    @error('nationality')
              ...
              <div class="row">
                <div class="col-md-6">
                  <div class="mb-3">
                    ...
                    <textarea name="residential_address" 
                              ...
                              rows="3">{{ old('residential_address') }}</textarea>
                ...
                <div class="col-md-6">
                  <div class="mb-3">
                    <label for="physical_address" class="form-label">Billing Address</label>
                    <textarea name="physical_address" 
                              id="physical_address" 
                              class="form-control @error('physical_address') is-invalid @enderror" 
                              rows="3">{{ old('physical_address') }}</textarea>
                ...
                <div class="col-md-6">
                  <div class="mb-3">
                    ...
                    <select name="country_name" id="country_name" class="form-select select2-multi @error('country_name') is-invalid @enderror">
                      <option value="">Select Country</option>
                      @foreach($countries as $country)
                        <option value="{{ $country['name'] }}" {{ old('country_name') === $country['name'] ? 'selected' : '' }}>
                          <img src="{{ $country['flag'] }}" alt="{{ $country['name'] }}" class="flag-icon"> {{ $country['name'] }}
                        </option>
                      @endforeach
                    </select>
                ...
                <div class="col-md-6">
                  <div class="mb-3">
                    ...
                    <select name="gown_size" id="gown_size" class="form-select @error('gown_size') is-invalid @enderror">
                      ...
                      <option value="XS" {{ old('gown_size') === 'XS' ? 'selected' : '' }}>Extra Small (XS)</option>
                      <option value="S" {{ old('gown_size') === 'S' ? 'selected' : '' }}>Small (S)</option>
                      <option value="M" {{ old('gown_size') === 'M' ? 'selected' : '' }}>Medium (M)</option>
                      <option value="L" {{ old('gown_size') === 'L' ? 'selected' : '' }}>Large (L)</option>
                      <option value="XL" {{ old('gown_size') === 'XL' ? 'selected' : '' }}>Extra Large (XL)</option>
                      <option value="XXL" {{ old('gown_size') === 'XXL' ? 'selected' : '' }}>Double XL (XXL)</option>
                    </select>
                    @error('gown_size')
                      <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                ...
                <div class="col-md-6">
                  <div class="mb-3">
                    ...
                    <textarea name="dietary_preferences" 
                              ...
                              rows="3" 
                              placeholder="Vegetarian, vegan, allergies, etc...">{{ old('dietary_preferences') }}</textarea>
            ...
            <div class="card-body">
              ...
              <div class="form-check mb-2">
                <input class="form-check-input" 
                       ...
                       value="{{ $club->id }}" 
                       id="club{{ $club->id }}"
                       {{ in_array($club->id, old('guest_club_id', [])) ? 'checked' : '' }}>
