    ...
    <div class="row">
      <div class="col-md-8">
        ...
        <div class="card card-info card-outline">
          ...
          <form action="{{ route('tenant.permissions.store') }}" method="POST">
            @csrf
            <div class="card-body">
              <div class="mb-3">
            ...
            <div class="card-footer">
              <div class="d-flex justify-content-between">
                <a href="{{ route('tenant.permissions.index') }}" class="btn btn-outline-secondary">
      ...
      <div class="col-md-4">
        ...
        <div class="card card-outline card-warning">
          ...
          <div class="card-body">
            ...
            <a href="{{ route('tenant.permissions.index') }}" class="btn btn-warning w-100">
