  ...
  <div class="container-fluid">
    ...
    <div class="card card-info card-outline mb-4">
      <div class="card-header">
        <div class="d-flex justify-content-between align-items-center">
          ...
          <div>
            <a href="{{ route('tenant.roles.index') }}" class="btn btn-outline-primary me-2">
            ...
            <div class="btn-group">
              ...
              <ul class="dropdown-menu">
                <li><a class="dropdown-item" href="{{ route('tenant.permissions.create') }}">
              ...
              <div class="d-flex justify-content-between align-items-center mb-2 p-2  rounded">
                ...
                <div class="d-flex align-items-center">
                  ...
                  <div class="btn-group btn-group-sm">
                    <a href="{{ route('tenant.permissions.show', $permission) }}" 
                       class="btn btn-outline-primary btn-sm" title="View Details">
                      <i class="fas fa-eye"></i>
                    </a>
                    @can('manage permissions')
                    <a href="{{ route('tenant.permissions.edit', $permission) }}" 
                       class="btn btn-outline-warning btn-sm" title="Edit Permission">
                      <i class="fas fa-edit"></i>
                    </a>
                    @if($permission->roles_count == 0)
                    <form action="{{ route('tenant.permissions.destroy', $permission) }}" method="POST" class="d-inline"
    ...
    <div class="card">
      <div class="card-body text-center py-5">
        ...
        @can('manage permissions')
        <a href="{{ route('tenant.permissions.create') }}" class="btn btn-info">
...
<div class="modal fade" id="bulkCreateModal" tabindex="-1">
  <div class="modal-dialog">
    <div class="modal-content">
      <form action="{{ route('tenant.permissions.bulk-create') }}" method="POST">
        @csrf
