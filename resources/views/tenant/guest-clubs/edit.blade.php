...
@section('title', 'Edit Guest Club - ' . $guestClub->name)
...
<div class="app-content">
  <div class="container-fluid">
    ...
    <form method="POST" action="{{ route('tenant.guest-clubs.update', $guestClub) }}">
      @csrf
      @method('PATCH')
            ...
            <div class="card-body">
                ...
                <div class="col-md-6">
                  <div class="mb-3">
                    ...
                    <input type="text" 
                           ...
                           name="tier_level" 
                           value="{{ old('tier_level', $guestClub->tier_level) }}" 
              ...
              <div class="mb-3">
                ...
                <textarea class="form-control @error('description') is-invalid @enderror" 
                          name="description" 
                          rows="3" 
                          placeholder="Describe the guest club and its purpose">{{ old('description', $guestClub->description) }}</textarea>
                @error('description')
                <div class="invalid-feedback">{{ $message }}</div>
                @enderror
              </div>
                ...
                <div class="col-md-4">
                  <div class="mb-3">
                    ...
                    <input type="number" 
                           ...
                           name="tier_priority" 
                           value="{{ old('tier_priority', $guestClub->tier_priority) }}" 
                           min="0" 
                           max="100"
                           placeholder="0-100">
                ...
                <div class="col-md-4">
                  <div class="mb-3">
                    ...
                    <input type="color" 
                           ...
                           name="badge_color" 
                           value="{{ old('badge_color', $guestClub->badge_color) }}">
                    @error('badge_color')
                    <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                  </div>
                ...
                <div class="col-md-6">
                  <div class="mb-3">
                    ...
                    <input type="number" 
                           ...
                           name="min_bookings" 
                           value="{{ old('min_bookings', $guestClub->min_bookings) }}" 
                           min="0">
                ...
                <div class="col-md-6">
                  <div class="mb-3">
                    ...
                    <input type="number" 
                           ...
                           name="min_spend" 
                           value="{{ old('min_spend', $guestClub->min_spend) }}" 
                           min="0" 
                           step="0.01">
                ...
                <div class="col-md-6">
                  <div class="mb-3">
                    ...
                    <input type="number" 
                           ...
                           value="{{ old('benefits.discount_percentage', $guestClub->benefits['discount_percentage'] ?? '') }}" 
                           min="0" 
                           max="100" 
                           step="0.1">
                ...
                <div class="col-md-6">
                  <div class="mb-3">
                    ...
                    <input type="number" 
                           ...
                           value="{{ old('benefits.spa_discount', $guestClub->benefits['spa_discount'] ?? '') }}" 
                           min="0" 
                           max="100" 
                           step="0.1">
                ...
                <div class="col-md-6">
                  <div class="mb-3">
                    ...
                    <input type="number" 
                           ...
                           value="{{ old('benefits.restaurant_discount', $guestClub->benefits['restaurant_discount'] ?? '') }}" 
                           min="0" 
                           max="100" 
                           step="0.1">
                ...
                <div class="col-md-4">
                  <div class="form-check mb-3">
                    <input class="form-check-input" 
                           ...
                           value="1" 
                           id="late_checkout"
                           {{ old('benefits.late_checkout', $guestClub->benefits['late_checkout'] ?? false) ? 'checked' : '' }}>
                ...
                <div class="col-md-4">
                  <div class="form-check mb-3">
                    <input class="form-check-input" 
                           ...
                           value="1" 
                           id="early_checkin"
                           {{ old('benefits.early_checkin', $guestClub->benefits['early_checkin'] ?? false) ? 'checked' : '' }}>
                ...
                <div class="col-md-4">
                  <div class="form-check mb-3">
                    <input class="form-check-input" 
                           ...
                           {{ old('benefits.complimentary_wifi', $guestClub->benefits['complimentary_wifi'] ?? false) ? 'checked' : '' }}>
                ...
                <div class="col-md-4">
                  <div class="form-check mb-3">
                    <input class="form-check-input" 
                           ...
                           {{ old('benefits.complimentary_breakfast', $guestClub->benefits['complimentary_breakfast'] ?? false) ? 'checked' : '' }}>
                ...
                <div class="col-md-4">
                  <div class="form-check mb-3">
                    <input class="form-check-input" 
                           ...
                           value="1" 
                           id="room_upgrade"
                           {{ old('benefits.room_upgrade', $guestClub->benefits['room_upgrade'] ?? false) ? 'checked' : '' }}>
                ...
                <div class="col-md-4">
                  <div class="form-check mb-3">
                    <input class="form-check-input" 
                           ...
                           value="1" 
                           id="airport_shuttle"
                           {{ old('benefits.airport_shuttle', $guestClub->benefits['airport_shuttle'] ?? false) ? 'checked' : '' }}>
                ...
                <div class="col-md-6">
                  <div class="form-check mb-3">
                    <input class="form-check-input" 
                           ...
                           value="1" 
                           id="priority_booking"
                           {{ old('benefits.priority_booking', $guestClub->benefits['priority_booking'] ?? false) ? 'checked' : '' }}>
                ...
                <div class="col-md-6">
                  <div class="form-check mb-3">
                    <input class="form-check-input" 
                           ...
                           {{ old('benefits.concierge_service', $guestClub->benefits['concierge_service'] ?? false) ? 'checked' : '' }}>
        ...
        <div class="col-md-4">
            ...
            <div class="card-body">
              <div class="form-check mb-3">
                <input class="form-check-input" 
                       ...
                       value="1" 
                       id="is_active"
                       {{ old('is_active', $guestClub->is_active) ? 'checked' : '' }}>
          ...
          <div class="card mt-3">
            ...
            <div class="card-body text-center">
              <div id="preview-badge" class="club-badge mx-auto mb-3" style="background-color: {{ $guestClub->badge_color }};">
                @if($guestClub->icon)
                <i id="preview-icon" class="{{ $guestClub->icon }}"></i>
                @else
                <span id="preview-text">{{ strtoupper(substr($guestClub->name, 0, 2)) }}</span>
                @endif
              </div>
              <h6 id="preview-name">{{ $guestClub->name }}</h6>
              <small id="preview-tier" class="text-muted">{{ $guestClub->tier_level ? $guestClub->tier_level . ' Tier' : '' }}</small>
            </div>
          </div>
            ...
            <div class="card-body">
              <div class="d-grid gap-2">
                <button type="submit" class="btn btn-primary">
                  <i class="fas fa-save"></i> Update Guest Club
                </button>
                ...
                <a href="{{ route('tenant.guest-clubs.members', $guestClub) }}" class="btn btn-outline-info">
                  <i class="fas fa-users"></i> View Members ({{ $guestClub->members_count }})
                </a>
              </div>
            </div>
          </div>
