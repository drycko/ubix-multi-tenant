...
if ( ! $packageId ) {
    abort(404, 'Package not specified.');
}
$package = App\Models\Tenant\Package::findOrFail($packageId) ?? null;
                            ...
                            <label class="inner-box">
                              ...
                              <div class="lower-content">
                                ...
                                <ul class="info">
                                  ...
                                  <li><button type="button" class="theme-btn small bg-green btn-style-one select-room" data-room-id="{{ $room->id }}">Book Now</button></li>
                                </ul>
                              </div>
