...
<div class="app-content-header">
  ...
  <div class="container-fluid">
    ...
    <div class="row mb-2">
      <div class="col-sm-6">
        <h3 class="mb-0">
          <i class="fas fa-user-tag"></i> <small class="text-muted">Roles Management</small>
        </h3>
      </div>
      <div class="col-sm-6">
    ...
    <div class="card card-primary card-outline mb-4">
      <div class="card-header">
        <div class="d-flex justify-content-between align-items-center">
          ...
          @can('manage roles')
          <div>
            <a href="{{ route('tenant.role-assignments.index') }}" class="btn btn-outline-info me-2">
              ...
              <tr>
                ...
                <td>
                  <div class="btn-group btn-group-sm">
                    <a href="{{ route('tenant.roles.show', $role) }}" class="btn btn-outline-primary" title="View Details">
                      <i class="fas fa-eye"></i>
                    </a>
                    @can('manage roles')
                    @if(!in_array($role->name, ['super-user', 'super-manager', 'support']))
                    <a href="{{ route('tenant.roles.edit', $role) }}" class="btn btn-outline-warning" title="Edit Role">
                      <i class="fas fa-edit"></i>
                    </a>
                    @if($role->users_count == 0)
                    <form action="{{ route('tenant.roles.destroy', $role) }}" method="POST" class="d-inline"
        ...
        <div class="card card-outline card-info">
          ...
          <div class="card-body">
            <div class="d-grid gap-2">
              <a href="{{ route('tenant.permissions.index') }}" class="btn btn-outline-primary">
                <i class="fas fa-key me-2"></i>Manage Permissions
              </a>
              <a href="{{ route('tenant.role-assignments.index') }}" class="btn btn-outline-success">
