...
<body>
    <div class="container">
        ...
        <div class="message">
            <p>Your payment is being processed by PayGate. This usually takes a few seconds.</p>
        ...
        <div style="margin-top: 40px;">
            <a href="{{ route('tenant.booking-invoices.public-view', $bookingInvoice) }}" class="btn btn-primary">
