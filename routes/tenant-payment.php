...
Route::post('tg/payfast/initiate', [PayfastGatewayController::class, 'initiate'])->name('tenant.payfast.initiate');
...
Route::post('tg/paygate/return', [PaygateGatewayController::class, 'return'])->name('tenant.paygate.return');
Route::post('tg/paygate/cancel', [PaygateGatewayController::class, 'return'])->name('tenant.paygate.cancel');
Route::post('tg/paygate/notify', [PaygateGatewayController::class, 'notify'])->name('tenant.paygate.notify');
